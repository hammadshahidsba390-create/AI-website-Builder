...
import { createProject, makeRevision, rollbackToVersion, getProject, getProjects, deleteProject, togglePublish, getPublishedProjects, saveProjectCode, getProjectCode } from '../controllers/ProjectController.js';
...
projectRouter.get('/public/:projectId', getProjectCode);
